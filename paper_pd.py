...
if __name__ == '__main__':
	# path = '/home/renansantos/Área de Trabalho/PD/Resultados/Online/r100n12tw10k4/'
	# path = '/home/renansantos/Área de Trabalho/PD/Resultados/Teste2/CL_NSGAII/'
	path = '/home/renansantos/Área de Trabalho/PD/Teste BETH/CL_NSGA-II_5/r050n12tw10k4/'
	number_of_paretos = 30
	cl_nsga = []
	nsga = []
	...
	for i in range(0,number_of_paretos):
		...
		size1.append(len(data1))
		# print('PD(CL-NSGA-II) = ' + str(pure_diversity(data1)/len(data1)))
		# cl_nsga.append(pure_diversity(data1)/len(data1))
		print('PD(CL-NSGA-II) = ' + str(pure_diversity(data1)))
		cl_nsga.append(pure_diversity(data1))
	
	# path = '/home/renansantos/Área de Trabalho/PD/Resultados/Teste2/NSGAII/'
	# path = '/home/renansantos/Área de Trabalho/PD/Resultados/Offline/r050n12tw10k4/'
	path = '/home/renansantos/Área de Trabalho/PD/Teste BETH/NSGA-II/r050n12tw10k4/'
	number_of_paretos = 30

	size2 = []
	for i in range(0,number_of_paretos):
		data2 = read_solutions(path + 'NSGAII-Pareto-'+ str(i)+'.csv')
		size2.append(len(data2))
		# print('PD(NSGA-II) = ' + str(pure_diversity(data2)/len(data2)))
		# nsga.append(pure_diversity(data2)/len(data2))
	...
	plt.title('PD')
	plt.ylabel('Pure Diversity')
	plt.savefig('PD' +'.eps',bbox_inches='tight')
	plt.show()


	# data_sizes = [size1, size2]
	# plt.figure()
	# plt.boxplot(data_sizes)
	# plt.xticks([1, 2], ['CL-NSGA-II','NSGA-II'])
